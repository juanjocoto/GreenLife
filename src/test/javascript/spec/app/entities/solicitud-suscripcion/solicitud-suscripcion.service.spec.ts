...
describe('Service Tests', () => {
    ...
    describe('SolicitudSuscripcion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SolicitudSuscripcionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/solicitud-suscripcions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SolicitudSuscripcion', () => {
