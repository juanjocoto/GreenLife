...
describe('Service Tests', () => {
    ...
    describe('SolicitudPatrocinio Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SolicitudPatrocinioService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/solicitud-patrocinios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SolicitudPatrocinio', () => {
