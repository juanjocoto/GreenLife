...
import { PagoDialogComponent } from '../../../../../../main/webapp/app/entities/pago/pago-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Pago Management Dialog Component', () => {
        let comp: PagoDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(PagoDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'pagoListModification', content: 'OK'});
