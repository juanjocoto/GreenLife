...
describe('Service Tests', () => {
    ...
    describe('CadenaOrdenRecoleccion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CadenaOrdenRecoleccionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cadena-orden-recoleccions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CadenaOrdenRecoleccion', () => {
