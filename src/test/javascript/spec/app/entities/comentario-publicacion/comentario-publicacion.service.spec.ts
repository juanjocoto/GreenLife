...
describe('Service Tests', () => {
    ...
    describe('ComentarioPublicacion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ComentarioPublicacionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/comentario-publicacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ComentarioPublicacion', () => {
