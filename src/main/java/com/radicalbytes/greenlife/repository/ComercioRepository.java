...
public interface ComercioRepository extends JpaRepository<Comercio, Long> {
    ...
    @Query("select comercio from Comercio comercio left join fetch comercio.etiquetas left join fetch comercio.categorias WHERE comercio.nombreComercial =:nombreComercial")
    Comercio findByNombreComercial(@Param("nombreComercial")String nombreComercial);
