...
import com.radicalbytes.greenlife.web.rest.util.PaginationUtil;
...
public class UserResource {
    ...
    @PutMapping("/users/register/comerciante")
    @Timed
    public ResponseEntity<UserDTO> confgComerciante(@RequestParam boolean value) {

        return ResponseUtil.wrapOrNotFound(userService.registerComerciante(value).map(UserDTO::new));
