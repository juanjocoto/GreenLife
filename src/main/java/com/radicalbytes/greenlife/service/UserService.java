...
import com.radicalbytes.greenlife.config.Constants;
import com.radicalbytes.greenlife.repository.UserRepository;
import com.radicalbytes.greenlife.repository.search.UserSearchRepository;
import com.radicalbytes.greenlife.security.AuthoritiesConstants;
import com.radicalbytes.greenlife.security.SecurityUtils;
import com.radicalbytes.greenlife.service.util.RandomUtil;
...
public class UserService {
    ...
    public User registerUser(UserDTO userDTO, String password) {
        ...
        Authority clienteAuthority = authorityRepository.findOne(AuthoritiesConstants.CLIENTE);
        ...
        authorities.add(clienteAuthority);
    ...
    public Optional<User> registerComerciante(boolean value) {
        Optional<User> optional = getUserWithAuthorities();
        Authority auth = authorityRepository.findOne(AuthoritiesConstants.COMERCIO);
